...
import { directFetcher, type Provider, type ProviderModel, type UpstreamProviderKind, type UpstreamRecord } from '@floway-dev/provider';
...
const stubInstance = (
  ...
  kind: UpstreamProviderKind = 'custom',
): Provider => ({
  upstream: upstreamId,
  kind,
  name: upstreamId,
