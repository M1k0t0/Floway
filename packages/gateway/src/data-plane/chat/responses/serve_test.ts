...
import { directFetcher, type ModelProvider, type ProviderStreamResult, type UpstreamCallOptions } from '@floway-dev/provider';
...
const makeCandidate = (overrides: {
  ...
  const provider = stubProvider({
    ...
    ...(overrides.callResponses !== undefined ? { callResponses: overrides.callResponses } : {}),
