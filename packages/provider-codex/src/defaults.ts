...
export const CODEX_DEFAULT_FLAGS: FlagDefaults = {
  ...
  // Codex's Responses Lite wire carries base instructions as leading
  // developer messages, so converting unsupported system input preserves the
  // representation used by the official client.
