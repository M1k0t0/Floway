...
// https://github.com/openai/codex/blob/3d2ee51ca2d5db578f328aa75e20aa22c0197c9a/codex-rs/models-manager/models.json#L1-L69
export const CODEX_CLI_VERSION = '0.153.4';

// Transport markers used by official Codex whenever model metadata selects
// Responses Lite. HTTP carries the header; Responses-over-WebSocket mirrors it
// into each request's client_metadata.
