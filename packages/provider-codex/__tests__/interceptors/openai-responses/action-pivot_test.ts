...
// Terminal dispatch MUST use the post-chain `ctx.action`. A final interceptor
// pivots generate to compact, which MUST route to /codex/responses/compact.
// Compact requests MUST preserve Codex compact extensions and strip fields
// unsupported by compact.
...
test('Codex terminal dispatches on post-chain ctx.action (interceptor flip generate→compact routes to /responses/compact, preserves compact extensions, and strips unsupported fields)', async () => {
